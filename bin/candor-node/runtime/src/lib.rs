...
pub const LOG_TARGET: &str = "runtime::io";
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("candor-node"),
	impl_name: create_runtime_str!("candor-node"),
	authoring_version: 1,
...
parameter_types! {
	pub MaximumSchedulerWeight: Weight = 0;
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		Vote: pallet_vote::{Pallet, Call, Storage, Event<T>}
	}
);
